...
foreach ($cursor as $document) {
    ...
    if ($document['GamingNow'] != false) {
        $theGamePage['GamingNow'] = '<li><span class="btn btn-small btn-yellow btn-label">Сейчас</span></li>';
    } else {
        $theGamePage['GamingNow'] = '<li>'.date("d/m", strtotime($document['Date'])).'</li>';
    }
}
...
$theGamePage['xbetGameLink'] = $document['xbetGameLink'];
?>
    <!-- BreadCrumbs -->
        ...
        <div class="tab-content">
            <div id="table1" class="tab-pane fade in active">
                <ul class="event-details padding border-bottom clearfix">
                    ...
                    <?php echo $theGamePage['GamingNow'];?>
                    <li><strong><?php echo $theGamePage['Team1Rus'].' - '.$theGamePage['Team2Rus']; ?></strong></li>
                </ul>

                <div class="hidden-xs">
                    <?php include('includes/stakes-table-3.php'); ?>
                </div>

                <div class="visible-xs">
                    <?php include('includes/stakes-table-4.php'); ?>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-game-details style2 border-bottom">
        ...
        <div class="game-teams padding" style="background-image: url(/images/temp/game-details-bg.jpg);">
            ...
            <a href="#" class="btn btn-yellow">УЗНАТЬ ПРОГНОЗ НА ДРУГИЕ СОБЫТИЯ</a>
        </div>
    </section>
    <!--/ Game Details Style 2 -->
    ...
    <section class="section-game-details border-bottom">
        <div class="game-time padding border-bottom">Время игры: <?php echo $theGamePage['MatchTime']; ?></div>
